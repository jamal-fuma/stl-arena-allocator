...
AC_DEFUN([FUMA_AX_SET_POSTGRES_PATH],[dnl
#---------------------------------------------------------------
# FUMA_AX_SET_POSTGRES_PATH start
#---------------------------------------------------------------
# default to wanting postgred and searching for a path
fuma_ax_$2_path="";
